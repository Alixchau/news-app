...
const fetchNews = async (
    ...
    const query = `http://api.mediastack.com/v1/news?access_key=${process.env.MEDIASTACK_API_KEY}&languages=en&category=${category}&keyword=${keywords}&sort=published_desc&limit=10&offset=0`
